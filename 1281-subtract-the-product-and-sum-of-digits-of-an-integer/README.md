<h2><a href="https://leetcode.com/problems/subtract-the-product-and-sum-of-digits-of-an-integer/">1281. Subtract the Product and Sum of Digits of an Integer</a></h2><h3>Easy</h3><hr><div style="user-select: auto;">Given an integer number <code style="user-select: auto;">n</code>, return the difference between the product of its digits and the sum of its digits.
