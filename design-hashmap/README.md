<h2>706. Design HashMap</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Design a HashMap without using any built-in hash table libraries.</p>
